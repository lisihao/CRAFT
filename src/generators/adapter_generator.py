...
class AdapterGenerator:
    ...
    def _build_template_context(
        ...
        return {
            ...
            # Adapter info
            "adapter_package": f"noah.adapters.{android_api.package}",
    ...
    def _generate_java_adapter_inline(self, context: Dict[str, Any]) -> str:
        ...
        lines = [
            f"/**",
            f" * Auto-generated by NOAH v{context['generator_version']}",
            f" * Source: {context['android_full_name']}",
            f" * Target: {context['harmony_full_name']}",
            f" * Confidence: {context['confidence']}",
            f" * Generated: {context['generated_at']}",
            f" *",
            f" * DO NOT EDIT MANUALLY - regenerate using NOAH pipeline",
            f" */",
            f"",
