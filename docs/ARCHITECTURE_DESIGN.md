...
CRAFT 是一个 **AI 驱动的自动化 API 适配层生成系统**，旨在通过高度自动化的方式，大规模生成 Android API 到 HarmonyOS API 的转接代码。
...
```java
// Auto-generated by CRAFT
// Source: {android_class}
// Target: {harmony_class}
// Confidence: {confidence_score}

package craft.adapters.{package};
